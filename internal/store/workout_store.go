...
func (pg *PostgresWorkoutStore) CreateWorkout(workout *Workout) (*Workout, error) {
	...
	defer tx.Rollback() // if anything happens in this function, we can rollback this function to a state when we called this function.
	// this is to maintain atomicity
	...
	// If we reach this point, it means all inserts were successful
	err = tx.Commit()
	if err != nil {
		return nil, err
	}
